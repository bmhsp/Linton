<div class="relative" x-data="{ result: true }" @click.away="result = false">
	<input 
		...
		type="text" 
		class="bg-white bg-opacity-20 bg-clip-padding backdrop-filter backdrop-blur w-64 px-4 pl-8 py-1 ml-3 text-xs md:text-md focus:outline-none placeholder-white"  
	...
	<div class="absolute top-0">
		<svg class="w-3 text-white mt-2 ml-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
